...
class Description extends Component {
  ...
  handleBackNavigation = () => {
    if (Global.SearchProduct == 'Products') {
      this.props.navigation.navigate(this.state.sourcePage,
        { sourcePage: 'SubCategory', data: { parent: this.state.categoryId } });
    } else if (Global.SearchProduct == 'Wishlist') {
      this.props.navigation.navigate(this.state.sourcePage);
    } else {
  ...
  openCartPage() {
    this.props.navigation.navigate('Checkout', { sourcePage: 'Description' });
  }
  ...
  searchNavigation(value) {
    if (this.state.sourcePage == 'Wishlist') {
      Global.SearchSourceNavKey = 'Wishlist';
    } else if (this.state.sourcePage == 'Wishlist') {
      Global.SearchSourceNavKey = 'ProductCategories';
    }
    this.props.navigation.navigate('Search',
      { sourcePage: 'Products', data: value })
  }
            ...
            <ScrollView>
              <View>
                <Text style={[styles.infoText, {
                  ...
                  fontSize: Global.TxtTittleFontSize
